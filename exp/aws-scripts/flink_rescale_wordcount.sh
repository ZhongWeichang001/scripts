...
WORDFILE_PATH=/home/yinhan/flink-exp/data/Sonnet-12-words
...
# #/home/yinhan/flink-1.12.0/build-target/bin/flink rescale -rmd 3 -rp 2 ${JOB_ID}
sleep 500
echo `/home/yinhan/flink-1.12.0/build-target/bin/flink cancel ${JOB_ID}`
...
sleep 2
echo rescale 0
/home/yinhan/flink-1.12.0/build-target/bin/flink rescale -rmd 0 -rpl [${OPERATOR_NAME}:1] ${JOB_ID}
sleep 2
echo rescale 1
/home/yinhan/flink-1.12.0/build-target/bin/flink rescale -rmd 1 ${JOB_ID}
sleep 2
